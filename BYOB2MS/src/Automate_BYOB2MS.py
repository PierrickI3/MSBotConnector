...
MS_BOT_AUTHORIZATION_SECRET = "Bearer aNieNrIsk3k.YcKFpSi-nPShwuL9Jhji00-218c2f2P8xDBSaq7A0IE"
...
def lambda_handler(event, context):
    ...
    if 'Authorization' not in event['headers'] or (event['headers']['Authorization'] != '12345'):
